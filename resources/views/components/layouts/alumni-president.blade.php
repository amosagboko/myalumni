...
<head>
    ...
    <title>{{ $title ?? config('app.name').' | Alumni President' }}</title>
    ...
    @stack('styles')
    <style>
        .alumni-president-slot > .main-content {
...
<body class="color-theme-blue mont-font">
    ...
    <div class="main-wrapper">
        <div class="nav-header bg-white shadow-xs border-0" style="position: relative;">
            <div class="nav-top">
                <a href="{{ route('alumni-president.home') }}">
            ...
            <div style="position: absolute; right: 20px; top: 50%; transform: translateY(-50%);">
                <div class="user-avatar-header-slot">
                    <x-user-avatar-dropdown dropdown-id="alumniPresidentAvatarDropdown" link-class="p-0 menu-icon" />
                </div>
            </div>
        </div>
            ...
            <div class="container ps-0 pe-0">
                <div class="nav-content">
                    <div class="nav-wrap bg-white bg-transparent-card rounded-3 shadow-sm ps-3 pe-3 pt-0 pb-3 mb-2 mt-2">
                        <div class="nav-caption fw-600 font-xssss text-grey-500"><span>President </span>Office</div>
                        <ul class="mb-1 pt-0">
                            <li class="nav-item">
                                <a href="{{ route('alumni-president.home') }}" class="nav-content-bttn open-font {{ request()->routeIs('alumni-president.home', 'alumni-president.dashboard') ? 'active' : '' }}">
                                    <i data-feather="home" class="btn-round-md me-3" style="width: 16px; height: 16px;"></i>
                                    <span>Dashboard</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('alumni-president.duties') }}" class="nav-content-bttn open-font {{ request()->routeIs('alumni-president.duties') ? 'active' : '' }}">
                                    <i data-feather="briefcase" class="btn-round-md me-3" style="width: 16px; height: 16px;"></i>
        ...
        <div class="alumni-president-slot">
