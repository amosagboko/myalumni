            ...
            <div class="container ps-0 pe-0">
                <div class="nav-content">
                    <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
                        <div class="nav-caption fw-600 font-xssss text-grey-500"><span>Dashboard</span></div>
                    ...
                    <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
                        <div class="nav-caption fw-600 font-xssss text-grey-500"><span>User Management</span></div>
                        <ul class="mb-1 top-content">
                            ...
                            <li><a href="{{ route('admin.users.create') }}" class="nav-content-bttn open-font"><i class="feather-user-plus btn-round-md bg-green-gradiant me-3"></i><span>Create User</span></a></li>
                            <li><a href="{{ route('upload.alumni') }}" class="nav-content-bttn open-font"><i class="feather-upload btn-round-md bg-red-gradiant me-3"></i><span>Upload Alumni</span></a></li>
                        </ul>
                    </div>

                    <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
                        <div class="nav-caption fw-600 font-xssss text-grey-500"><span>Content Management</span></div>
                        <ul class="mb-1 top-content">
                            <li><a href="{{ route('create.event.index') }}" class="nav-content-bttn open-font"><i class="feather-calendar btn-round-md bg-mini-gradiant me-3"></i><span>Events</span></a></li>
