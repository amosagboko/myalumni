                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="ads-page-header">
                            <div>
                                <h1 class="ads-page-title">Student Affairs Clearance Audit</h1>
                                <p class="ads-page-subtitle">Track student affairs clearance status changes.</p>
                            </div>
                            <div class="ads-page-actions d-flex flex-wrap gap-2">
                                ...
                                <a href="{{ route('student-affairs.clearance') }}" class="btn btn-sm btn-outline-secondary">
                            ...
                            @if ($logs->count() > 0)
                                <div class="adt-table-wrap">
                                    <table class="adt-table">
                                        ...
                                        <tbody>
                                            @foreach ($logs as $log)
                                                <tr wire:key="sa-audit-log-{{ $log->id }}">
