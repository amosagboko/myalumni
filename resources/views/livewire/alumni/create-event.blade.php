    ...
    <div class="col-xl-8 col-xxl-9 col-lg-8">
        ...
        <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
            <div class="card-body p-4">
                <h2 class="fw-700 text-grey-900 font-md mb-1">Create event</h2>
                <p class="font-xssss text-grey-500 mb-4">
                    Share an alumni community event with members. Submissions are reviewed before appearing in Discover.
                </p>

                <div class="alert alert-info font-xssss mb-4">
                    Events are published after review by the alumni relations team.
                </div>

                <form wire:submit="save">
                    @include('livewire.alumni.partials.event-form-fields')
                    ...
                    <div class="d-flex flex-wrap gap-2 pt-2 border-top">
                        <button type="submit"
                            ...
                            <span wire:loading.remove wire:target="save">Submit event</span>
