                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="ads-page-header">
                            <div>
                                <h1 class="ads-page-title">Academic Affairs Clearance</h1>
                                <p class="ads-page-subtitle">Review alumni eligibility and update academic affairs clearance status.</p>
                            </div>
                            <div class="ads-page-actions d-flex flex-wrap gap-2">
                                ...
                                <a href="{{ route('academic-affairs.audit') }}" class="btn btn-sm btn-outline-secondary">
                            ...
                            <div class="adt-toolbar border-top-0 pt-0">
                                <div class="d-flex flex-wrap align-items-center gap-2">
                                    ...
                                    <button
                                        ...
                                        wire:confirm="Clear selected alumni for Academic Affairs?"
                                    >
                                        Bulk clear
                                    </button>
                                    <button
                                        ...
                                        wire:confirm="Unclear selected alumni for Academic Affairs?"
                                    >
                                        Bulk unclear
                                    </button>
                                </div>
                                        ...
                                        <tbody>
                                            @foreach ($alumni as $a)
                                                @php
                                                    ...
                                                    $cleared = (bool) $a->academic_affairs_cleared;
                                                @endphp
                                                <tr wire:key="aa-clearance-{{ $a->id }}-{{ (int) $cleared }}">
                                                    <td>
                                                        <input
                                                            type="checkbox"
