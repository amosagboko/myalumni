<div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
    ...
    <div class="card-body d-flex p-0 mt-3">
        <button type="button" wire:click="toggleLike" class="emoji-bttn d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss me-2 border-0 bg-transparent">
        ...
        <button type="button" wire:click="toggleComments" class="d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss border-0 bg-transparent">
