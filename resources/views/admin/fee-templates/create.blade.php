        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold text-gray-800">Create Fee Template</h2>
                ...
                <form action="{{ route('admin.fee-templates.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Category (for 2025+) -->
                        <div id="category_section" class="hidden">
                            <label for="category_id" class="block text-sm font-medium text-gray-700 mb-2">Alumni Category *</label>
                    ...
                    <div class="flex justify-end space-x-3">
                        <a href="{{ route('admin.fee-templates.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-md">
                            Cancel
                        </a>
