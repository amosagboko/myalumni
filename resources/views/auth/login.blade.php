    ...
    <div class="main-wrap">
        ...
        <div class="nav-header bg-transparent shadow-none border-0">
            <div class="nav-top d-flex justify-content-between align-items-center w-100">
                <a href="{{ route('landing') }}"><img src="{{ asset('images/favicon.png') }}" alt="Fulafia DLAA" class="me-2 ms-0" style="width: 32px; height: 32px;"><span class="d-inline-block fredoka-font ls-3 fw-600 text-current font-xxl logo-text mb-0">Fulafia | DLAA</span></a>
